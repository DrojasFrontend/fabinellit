    ...
    <div class="position-relative">
        ...
        <div class="position-xl-absolute top-0 start-0 w-100 h-100 d-flex align-items-end">
            <div class="container bg-white">
                <div class="row py-xl-4 py-xl-3 p-3">
                    <div class="col-12 col-xl-1 mb-xl-0 mb-4">
                        <div class="d-flex justify-content-xl-center align-items-center h-100">
                            <img class="mx-xl-auto" width="51" height="51" src="<?php echo THEME_IMG; ?>icons/icon-airplane.svg" alt="Home 1">
                        </div>
                    </div>
