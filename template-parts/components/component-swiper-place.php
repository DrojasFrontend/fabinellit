                                    ...
                                    <?php foreach ($placesCartagena as $place) { ?>
                                        <div class="swiper-slide">
                                            <div class="bg-white-100 p-3 pb-4">
                                                ...
                                                <p class="fs-xl-4 fs-4 text-orange mt-3 text-uppercase"><?php echo $place["name"]; ?></p>
                                                <span class="line line--small line--left my-3"></span>
                                                <p class="fs-xl-6 text-gray-100 letter-spacing-xl-1 line-xl-height-normal line-height-20"><?php echo $place["copy"]; ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
